    ...
    providers: [
        {
            ...
            useExisting: forwardRef(() => RegistrationLoginValidator), multi: true
        }
    ]
})

export default class RegistrationLoginValidator implements Validator {
    ...
    loginAvailability = (control: AbstractControl) => {
